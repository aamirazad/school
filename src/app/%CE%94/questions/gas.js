export const questions = [
  [
    {
      instruction:
        "Calculate the number of moles (n) given 5.0 grams of H2 gas.",
      solution: 2.5,
      unit: "mol",
  ...
  [
    {
      instruction:
        "Calculate the number of moles (n) given 10.0 grams of O2 gas.",
      solution: 0.3125,
      unit: "mol",
      hint: "Use the molar mass of O2 (32 g/mol)",
    },
    {
      instruction:
        "Calculate the volume (V) of the gas at STP (Standard Temperature and Pressure).",
    ...
    {
      instruction:
        "Calculate the pressure (P) if the volume is increased to 14 L at constant temperature.",
      solution: 0.5,
      unit: "atm",
      hint: "Use Boyle's Law: P1V1 = P2V2",
    },
